<template>
  <footer
    :class="{
      'bg-moty-darker text-moty-lightest border-moty-oklight': background === 'dark',
  ...
  >
    <!-- Main footer -->
    <div class="container py-16 text-center border-b lg:flex lg:flex-row lg:text-left">
      <div class="my-10 lg:w-1/4 lg:my-0">
    ...
    <div
      :class="{
        'text-moty-lighter': background === 'dark',
        'bg-primary-light': background === 'light'
      }"
      class="py-4 text-sm text-center"
    >
      <div class="container lg:flex lg:flex-no-wrap lg:justify-between">
        <!-- Copyright & Settings -->
        <p class="my-3 text-sm">
          <span>© {{ store.name }}.me {{ currentYear }}</span>
        </p>
